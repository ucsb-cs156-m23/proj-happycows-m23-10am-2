...
@AllArgsConstructor
public class UpdateCowHealthJobSingleCommons implements JobContextConsumer  {
    ...
    public void accept(JobContext ctx) throws Exception {
        ...
        Optional<Commons> updatedCommons = commonsRepository.findById(commonsID);

        if(updatedCommons.isPresent()){
            Commons commons = updatedCommons.get();
