...
public class MilkTheCowsJobSingleCommonsTests {
    @Mock
    ...
    void test_log_output_no_commons() throws Exception {
        ...
        // Act
        MilkTheCowsJob milkTheCowsJob = new MilkTheCowsJobSingleCommons(commonsRepository, userCommonsRepository,
    ...
    void test_log_output_with_commons_and_user_commons() throws Exception {
        ...
        // Act
        MilkTheCowsJobSingleCommons MilkTheCowsJobSingleCommons = new MilkTheCowsJobSingleCommons(commonsRepository, userCommonsRepository,
                userRepository, profitRepository, 1L);
        MilkTheCowsJob.accept(ctx);
