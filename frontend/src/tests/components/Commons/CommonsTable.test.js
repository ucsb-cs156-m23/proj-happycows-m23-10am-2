...
describe("UserTable tests", () => {
  ...
  test("Has the expected column headers and content for adminUser", () => {
    ...
    const expectedFields = ["id", "name", "cowPrice", "milkPrice", "startingBalance", "startingDate", "lastdayDate", "degradationRate", "carryingCapacity", "capacityPerUser", "effectiveCapacity"];
